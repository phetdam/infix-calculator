...
elseif(PDCALC_FLEX_BISON_DIR STREQUAL "")
    message(STATUS "PDCALC_FLEX_BISON_DIR: (empty)")
else()
    message(STATUS "PDCALC_FLEX_BISON_DIR: ${PDCALC_FLEX_BISON_DIR}")
endif()
...
# make the messages nicer by indicating when variable is empty
elseif(PDCALC_FLEX_DIR STREQUAL "")
    message(STATUS "PDCALC_FLEX_DIR: (empty)")
else()
    message(STATUS "PDCALC_FLEX_DIR: ${PDCALC_FLEX_DIR}")
endif()
...
# make the messages nicer by indicating when variable is empty
elseif(PDCALC_BISON_DIR STREQUAL "")
    message(STATUS "PDCALC_BISON_DIR: (empty)")
else()
    message(STATUS "PDCALC_BISON_DIR: ${PDCALC_BISON_DIR}")
endif()
